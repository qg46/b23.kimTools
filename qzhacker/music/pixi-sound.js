 ...
 * Compiled Tue, 23 Apr 2019 02:37:04 UTC
 *
...
!function(e, t) {
    ...
    function o(e, t) {
        ...
        n._immediateFn(function() {
            ...
            if (null !== n) {
                ...
                (1 === e._state ? i : r)(t.promise, e._value)
        })) : e._deferreds.push(t)
    }
    function i(e, t) {
        try {
    ...
    var c = function() {
        ...
        Object.defineProperty(e.prototype, "filters", {
            ...
            set: function(e) {
                ...
                e && e.length) {
                    this._filters = e.slice(0),
                    this._input.disconnect();
                    var n = null;
                    e.forEach(function(e) {
                        null === n ? t._input.connect(e.destination) : n.connect(e.destination),
                        n = e
                    }),
    ...
    var y = function() {
      ...
      , g = function(e) {
        function t(t) {
            ...
            n._muted = !1,
            n._elapsed = 0,
            n._updateListener = n._update.bind(n),
            n.init(t),
            n
        }
        return h(t, e),
        ...
        t.prototype.refresh = function() {
            if (this._source) {
                ...
                y.setParamValue(this._gain.gain, i * o * n),
                y.setParamValue(this._source.playbackRate, this._speed * t.speed * e.speed)
            }
        }
        ,
        ...
        t.prototype.play = function(e) {
            ...
            this._source.start(0, t)) : n ? this._source.start(0, t, n - t) : this._source.start(0, t),
            this.emit("start"),
            this._update(!0),
            this._enabled = !0
        }
        ...
        Object.defineProperty(t.prototype, "_enabled", {
            set: function(e) {
                ...
                t.removeEventListener("audioprocess", this._updateListener),
                e && t.addEventListener("audioprocess", this._updateListener)
            },
            enumerable: !0,
            configurable: !0
        }),
            ...
            this._source) {
                ...
                if (n > 0 || e) {
                    ...
                    if (this._source.loopStart) {
                        ...
                        r = this._elapsed % i / i;
                    this._progress = r,
                    this.emit("progress", this._progress, i)
                }
            }
        }
        ,
      ...
      , b = function(e) {
        function t(t) {
            ...
            (n = e.call(this, u, s) || this).context = t,
            n.bufferSource = i,
            n.script = r,
            n.gain = s,
            n.analyser = u,
        ...
        t.prototype.cloneBufferSource = function() {
            ...
            t.buffer = e.buffer,
            y.setParamValue(t.playbackRate, e.playbackRate.value),
            t.loop = e.loop;
      ...
      , v = function() {
        ...
        return e.prototype.init = function(e) {
            this.parent = e,
            this._nodes = new b(this.context),
      ...
      , P = function(e) {
        function t() {
            ...
            (n = e.call(this, s, r) || this)._ctx = i,
            n._offlineCtx = new t.OfflineAudioContext(1,2,o.OfflineAudioContext ? i.sampleRate : 44100),
            n._unlocked = !1,
            n.compressor = r,
            n.analyser = s,
            n.events = new PIXI.utils.EventEmitter,
            n.volume = 1,
            n.speed = 1,
            n.muted = !1,
            n.paused = !1,
            "running" !== i.state && (n._unlock(),
            n._unlock = n._unlock.bind(n),
            document.addEventListener("mousedown", n._unlock, !0),
            document.addEventListener("touchstart", n._unlock, !0),
        ...
        t.prototype.playEmptySound = function() {
            ...
            e.start(0, 0, 0),
            "suspended" === e.context.state && e.context.resume()
        }
        ,
        ...
        Object.defineProperty(t.prototype, "paused", {
            ...
            set: function(e) {
                e && "running" === this._ctx.state ? this._ctx.suspend() : e || "suspended" !== this._ctx.state || this._ctx.resume(),
                this._paused = e
            },
            enumerable: !0,
            configurable: !0
      ...
      , O = function(e) {
        function t(n, o, i, r, s, u, a, c, l, p) {
            ...
            if (!_().useLegacy) {
                var f = [{
                    ...
                    y.setParamValue(t.Q, 1),
                    t.frequency.value = e.f,
                    y.setParamValue(t.gain, e.gain),
                    t
                });
                (h = e.call(this, f[0], f[f.length - 1]) || this).bands = f,
                h.bandsMap = {};
                for (var d = 0; d < h.bands.length; d++) {
                    var m = h.bands[d];
                    d > 0 && h.bands[d - 1].connect(m),
                    h.bandsMap[m.frequency.value] = m
                }
                return h
            }
        ...
        return h(t, e),
        t.prototype.setGain = function(e, t) {
            if (void 0 === t && (t = 0),
            !this.bandsMap[e])
                throw new Error("No band found for frequency " + e);
      ...
      , j = function(e) {
        function t(t) {
            ...
            if (!_().useLegacy) {
                ...
                return (n = e.call(this, o) || this)._distortion = o,
                n.amount = t,
                n
            }
        ...
        Object.defineProperty(t.prototype, "amount", {
            ...
            set: function(e) {
                e *= 1e3,
                this._amount = e;
                for (var t, n = new Float32Array(44100), o = Math.PI / 180, i = 0; i < 44100; ++i)
                    t = 2 * i / 44100 - 1,
                    n[i] = (3 + e) * t * 20 * o / (Math.PI + e * Math.abs(t));
                this._distortion.curve = n,
      ...
      , w = function(e) {
        function t(t) {
            ...
            if (!_().useLegacy) {
                ...
                return s.createStereoPanner ? r = o = s.createStereoPanner() : ((i = s.createPanner()).panningModel = "equalpower",
                r = i),
                (n = e.call(this, r) || this)._stereo = o,
                n._panner = i,
                n.pan = t,
                n
            }
        ...
        Object.defineProperty(t.prototype, "pan", {
            ...
            set: function(e) {
                this._pan = e,
                this._stereo ? y.setParamValue(this._stereo.pan, e) : this._panner.setPosition(e, 0, 1 - Math.abs(e))
            },
            enumerable: !0,
            configurable: !0
        }),
      ...
      , A = function(e) {
        function t(t, n, o) {
            ...
            var i = this;
            if (!_().useLegacy)
                return (i = e.call(this, null) || this)._seconds = i._clamp(t, 1, 50),
        ...
        return h(t, e),
        t.prototype._clamp = function(e, t, n) {
        ...
        t.prototype._rebuild = function() {
            for (var e, t = _().context.audioContext, n = t.sampleRate, o = n * this._seconds, i = t.createBuffer(2, o, n), r = i.getChannelData(0), s = i.getChannelData(1), u = 0; u < o; u++)
                e = this._reverse ? o - u : u,
                r[u] = (2 * Math.random() - 1) * Math.pow(1 - e / o, this._decay),
                s[u] = (2 * Math.random() - 1) * Math.pow(1 - e / o, this._decay);
      ...
      , E = function(e) {
        function t() {
            ...
            if (!_().useLegacy) {
                ...
                return i.connect(o),
                (t = e.call(this, i, o) || this)._merger = i,
                t
            }
      ...
      , F = function(e) {
        function t() {
            if (!_().useLegacy) {
                ...
                return n.type = "lowpass",
                y.setParamValue(n.frequency, 2e3),
                o.type = "lowpass",
                y.setParamValue(o.frequency, 2e3),
                i.type = "highpass",
                y.setParamValue(i.frequency, 500),
                r.type = "highpass",
                y.setParamValue(r.frequency, 500),
                n.connect(o),
                o.connect(i),
                i.connect(r),
      ...
      , L = function(e) {
        ...
        t.prototype.play = function(e) {
            ...
            this._source.onloadedmetadata = function() {
                n._source && (n._source.currentTime = o,
                n._source.onloadedmetadata = null,
                n.emit("progress", o, n._duration),
                PIXI.ticker.shared.add(n._onUpdate, n))
            }
            ,
            this._source.onended = this._onComplete.bind(this),
            this._source.play(),
      ...
      , C = function(e) {
        ...
        t.prototype.load = function(e) {
            ...
            if (4 !== t.readyState) {
                if (!n.url)
                    return e(new Error("sound.url or sound.source must be set"));
                t.src = n.url;
                var o = function() {
    ...
    function B(e) {
        ...
        if (t.test(n)) {
            ...
            return "string" != typeof e && (e.extension = r,
            e.url = c),
            c
        }
        return n
    ...
    var V = function() {
        ...
        Object.defineProperty(e, "legacy", {
            set: function(e) {
                ...
                e ? n.forEach(function(e) {
                    t.setExtensionXhrType(e, t.XHR_RESPONSE_TYPE.DEFAULT),
                    t.setExtensionLoadType(e, t.LOAD_TYPE.AUDIO)
      ...
      , U = function(e) {
        ...
        return h(t, e),
        t.addPixiMiddleware = function(t) {
      ...
      , N = function() {
        ...
        return e.from = function(t) {
            var n = {};
            return "string" == typeof t ? n.url = t : t instanceof ArrayBuffer || t instanceof HTMLAudioElement ? n.source = t : n = t,
            (n = d({
                autoPlay: !1,
                singleInstance: !1,
                url: null,
            ...
            Object.freeze(n),
            new e(_().useLegacy ? new C : new v,n)
        }
        ,
        Object.defineProperty(e.prototype, "context", {
            get: function() {
        ...
        e.prototype.addSprites = function(e, t) {
            if ("object" == typeof e) {
                var n = {};
                for (var o in e)
                    n[o] = this.addSprites(o, e[o]);
                return n
            }
            if ("string" == typeof e) {
                var i = new H(this,t);
                return this._sprites[e] = i,
                i
            }
        }
        ,
        ...
        e.prototype.stop = function() {
            if (!this.isPlayable)
                ...
                this;
            this.isPlaying = !1;
            for (var e = this._instances.length - 1; e >= 0; e--)
        ...
        e.prototype.play = function(e, t) {
            ...
            return this._instances.push(s),
            this.isPlaying = !0,
            s.once("end", function() {
                n.complete && n.complete(o),
                o._onComplete(s)
            }),
        ...
        e.prototype.refresh = function() {
            for (var e = this._instances.length, t = 0; t < e; t++)
        ...
        e.prototype._poolInstance = function(t) {
            t.destroy(),
            e._pool.indexOf(t) < 0 && e._pool.push(t)
        }
        ,
        e._pool = [],
        e
      ...
      , z = function() {
        ...
        return e.prototype.init = function() {
            return this.supported && (this._webAudioContext = new P),
            this._htmlAudioContext = new M,
            this._sounds = {},
        ...
        e.prototype.add = function(e, t) {
            ...
            if ("string" == typeof e) {
                if (t instanceof N)
                    return this._sounds[e] = t,
                    t;
                i = this._getOptions(t);
                var r = N.from(i);
                return this._sounds[e] = r,
                r
            }
        }
        ,
        ...
        Object.defineProperty(e.prototype, "useLegacy", {
            ...
            set: function(e) {
                V.legacy = e,
                this._useLegacy = e,
                this._context = !e && this.supported ? this._webAudioContext : this._htmlAudioContext
            },
            enumerable: !0,
            configurable: !0
        }),
        ...
        e.prototype.volume = function(e, t) {
            var n = this.find(e);
            return void 0 !== t && (n.volume = t),
            n.volume
        }
        ,
        e.prototype.speed = function(e, t) {
            var n = this.find(e);
            return void 0 !== t && (n.speed = t),
            n.speed
        }
        ,
    ...
    var Y = Object.freeze({
      ...
      , J = window
      , Q = PIXI;
    if ("undefined" == typeof Promise && (J.Promise = n),
    void 0 !== PIXI.loaders) {
        var Z = parseInt(PIXI.VERSION.split(".")[0], 10);
        4 === Z ? (PIXI.loaders.Loader = U,
        V.add(),
        PIXI.loader.use(V.use),
        PIXI.loader.pre(V.pre)) : Z >= 5 && Q.Loader.registerPlugin(V)
    }
    return void 0 === J.__pixiSound && delete J.__pixiSound,
    Q.sound || (Object.defineProperty(Q, "sound", {
        get: function() {
            return $
        }
    }),
